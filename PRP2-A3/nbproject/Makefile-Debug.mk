...
${OBJECTDIR}/festoFunctions.o: festoFunctions.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I/D/Festo/lib -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/festoFunctions.o festoFunctions.c

${OBJECTDIR}/listDatabase.o: listDatabase.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I/D/Festo/lib -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/listDatabase.o listDatabase.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I/D/Festo/lib -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/stateMachine.o: stateMachine.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I/D/Festo/lib -std=c99 -MMD -MP -MF $@.d -o ${OBJECTDIR}/stateMachine.o stateMachine.c
